 ...
 * 
 * This file implements the BinaryBroadcastMessage class (AIS Message Type 8),
 * which is used for broadcasting binary data to all AIS stations in range.
 * 
 * The implementation handles the encoding and decoding of Binary Broadcast
 * Messages, including the application ID and binary data.
 * 
