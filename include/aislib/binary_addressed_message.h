 ...
 * 
 * This file defines the Binary Addressed Message (Type 6) used to send
 * application-specific data to a specific destination via AIS.
 * 
 * Binary Addressed Messages include a destination MMSI, sequence number,
 * and retransmit flag, in addition to the application ID and binary data
 * inherited from the BinaryMessage base class.
 * 
 * These messages are used for point-to-point communication of binary data
 * between AIS stations.
 * 
