 ...
 * 
 * This file defines the Binary Broadcast Message (Type 8) used to broadcast
 * application-specific data to all AIS stations in range.
 * 
 * Binary Broadcast Messages are similar to Binary Addressed Messages but are
 * intended for all stations rather than a specific recipient. They contain
 * an application ID and binary data inherited from the BinaryMessage base class.
 * 
 * These messages are used for broadcasting information such as area notices,
 * meteorological data, and other application-specific information.
 * 
