 ...
 * 
 * This file defines the base class for AIS binary messages (Types 6, 8, 25, 26).
 * Binary messages provide a mechanism for transmitting application-specific data
 * via AIS. The BinaryMessage class serves as a base for more specific binary
 * message types, handling common functionality like application ID management.
 * 
 * The application ID consists of a Designated Area Code (DAC) and a Function
 * Identifier (FI), which together determine the interpretation of the binary data.
 * 
